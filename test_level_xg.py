...
def build_feature_matrix(info_df, data_dir, label_col='level', augment=False): #hold racket handed
...
if __name__ == '__main__':
    ...
    # 建立測試集特徵
    X_test, _ = build_feature_matrix(test_csv, test_dir, label_col='level', augment=False)
    ...
    submission.to_csv('submission_level_probs_xgb.csv', index=False, float_format='%.4f')
